...
public class ResponseCreateAb {
	...
	public ResponseCreateAb() {
		super();
	}
	
	public ResponseCreateAb(String abId, String abName, String isNotified, String notifTransaksi, String corporateId,
	...
	public String toString() {
		return "ResponseCreateAb [abId=" + abId + ", abName=" + abName + ", isNotified=" + isNotified
				+ ", notifTransaksi=" + notifTransaksi + ", corporateId=" + corporateId + ", corpIdRegDate="
				+ corpIdRegDate + ", compCode=" + compCode + ", compCodeRegDate=" + compCodeRegDate + ", abInitial="
				+ abInitial + "]";
	}
